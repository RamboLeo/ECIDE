...
class PythonIDEClient:
    def __init__(self, root):
        self.root = root
        self.root.title("Python IDE 客户端 v2.0")
    ...
    def create_widgets(self):
        ...
        ttk.Button(console_input_frame, text="执行", command=lambda: self.execute_console_command(None)).pack(side=tk.RIGHT, padx=(5, 0))
        ...
        ttk.Button(package_toolbar, text="刷新已安装", command=self.refresh_installed_packages).pack(side=tk.LEFT, padx=(5, 0))
